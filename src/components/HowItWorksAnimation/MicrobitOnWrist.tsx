...
const MicrobitOnWrist = forwardRef<MicrobitOnWristRef>(function MicrobitOnWrist(
  _,
  ref
) {
    ...
    >
      ...
      <Svg
        ...
        css={{
          ...
          transformOrigin: move === "wave" ? "bottom center" : undefined,
        }}
        style={{
          animation:
            move === "bob"
              ? withPlayState(`wristBob 1.1s ease-in-out infinite`)
              : move === "wave"
              ? withPlayState(`wristWave 1.1s ease-in-out infinite`)
              : undefined,
        }}
      >
        {/* Hand outline */}
        ...
        />
        <path fill="#010101" d="M86.78,135.84l-17.53.91,8.27-9.22,9.27,8.31Z" />
