...
describe("Data connection flow: Radio", () => {
  describe("remote phase", () => {
    ...
    describe("error recovery", () => {
      ...
      it("TryAgainReplugMicrobit tryAgain -> ConnectCable", () => {
        const result = transition(DataConnectionStep.TryAgainReplugMicrobit, {
          type: "tryAgain",
        });
      ...
      it("TryAgainCloseTabs tryAgain -> ConnectCable", () => {
        const result = transition(DataConnectionStep.TryAgainCloseTabs, {
          type: "tryAgain",
        });
  ...
  describe("bridge phase", () => {
    ...
    describe("connecting microbits outcomes", () => {
      it("deviceConnected -> Connected with notifyConnected", () => {
        const result = transition(DataConnectionStep.ConnectingMicrobits, {
